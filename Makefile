...
DOC_INDEX = docs/_build/html/index.html
...
clean:
	...
	rm -rfv .coverage build/ dist/ docs/_build MANIFEST
...
help:
	@echo -e 'Django AMP Tools - list of make targets:\n'
